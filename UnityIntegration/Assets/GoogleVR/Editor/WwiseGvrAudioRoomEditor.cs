...
/// A custom editor for properties on the WwiseGvrAudioRoom script. This appears in the Inspector
/// window of a WwiseGvrAudioRoom object.
[CustomEditor(typeof(WwiseGvrAudioRoom))]
[CanEditMultipleObjects]
public class WwiseGvrAudioRoomEditor : Editor {
  ...
  private GUIContent roomEffectsBusNameLabel = new GUIContent("Room Effects Bus Name",
    "Name of the Wwise Audio Bus where the GVR Room Effects mixer plug-in is attached to.");
  ...
  public override void OnInspectorGUI () {
    ...
    WwiseGvrAudio.roomEffectsBusName = EditorGUILayout.TextField(roomEffectsBusNameLabel,
                                                                 WwiseGvrAudio.roomEffectsBusName);
    EditorGUI.EndDisabledGroup ();
    ...
    EditorGUILayout.Slider(reflectivity, 0.0f, WwiseGvrAudio.maxReflectivity, reflectivityLabel);

    EditorGUILayout.Separator();

    EditorGUILayout.LabelField(reverbPropertiesLabel);
    ++EditorGUI.indentLevel;
    EditorGUILayout.Slider(reverbGainDb, WwiseGvrAudio.minGainDb, WwiseGvrAudio.maxGainDb,
                           reverbGainLabel);
    EditorGUILayout.Slider(reverbBrightness, WwiseGvrAudio.minReverbBrightness,
                           WwiseGvrAudio.maxReverbBrightness, reverbBrightnessLabel);
    EditorGUILayout.Slider(reverbTime, 0.0f, WwiseGvrAudio.maxReverbTime, reverbTimeLabel);
    --EditorGUI.indentLevel;
