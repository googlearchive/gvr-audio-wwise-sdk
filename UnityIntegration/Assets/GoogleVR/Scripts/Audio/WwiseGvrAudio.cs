...
/// This is the main GVR audio class that communicates with the Wwise Unity integration. Native
/// functions of the system can only be called through this class to preserve the internal system
/// functionality.
public static class WwiseGvrAudio {
  ...
  private struct RoomProperties {
    ...
    public WwiseGvrAudioRoom.SurfaceMaterial materialLeft;
    public WwiseGvrAudioRoom.SurfaceMaterial materialRight;
    public WwiseGvrAudioRoom.SurfaceMaterial materialBottom;
    public WwiseGvrAudioRoom.SurfaceMaterial materialTop;
    public WwiseGvrAudioRoom.SurfaceMaterial materialFront;
    public WwiseGvrAudioRoom.SurfaceMaterial materialBack;
