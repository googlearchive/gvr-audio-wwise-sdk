...
[AddComponentMenu("GoogleVR/Audio/WwiseGvrAudioRoom")]
public class WwiseGvrAudioRoom : MonoBehaviour, ISerializationCallbackReceiver {
  ...
  void OnEnable () {
    WwiseGvrAudio.UpdateAudioRoom(this, WwiseGvrAudio.IsListenerInsideRoom(this));
  }

  void OnDisable () {
    WwiseGvrAudio.UpdateAudioRoom(this, false);
  }
  ...
  public void OnBeforeSerialize () {
    roomEffectsBusName = WwiseGvrAudio.roomEffectsBusName;
  }

  public void OnAfterDeserialize () {
    WwiseGvrAudio.roomEffectsBusName = roomEffectsBusName;
  }
}
